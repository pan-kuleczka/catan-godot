...
static var MAP_SCHEMES : Dictionary = {
	"STANDARD_FOR_4" : MapScheme.new(
		{
			BoardPosition.new(-2, -1) : MapSchemeTileType.LAND,
			BoardPosition.new(-2, 0) : MapSchemeTileType.LAND,
			BoardPosition.new(-2, 1) : MapSchemeTileType.LAND,
			BoardPosition.new(-1, -2) : MapSchemeTileType.LAND,
			BoardPosition.new(-1, -1) : MapSchemeTileType.LAND,
			BoardPosition.new(-1, 0) : MapSchemeTileType.LAND,
			BoardPosition.new(-1, 1) : MapSchemeTileType.LAND,
			BoardPosition.new(-1, 2) : MapSchemeTileType.LAND,
			BoardPosition.new(0, -2) : MapSchemeTileType.LAND,
			BoardPosition.new(0, -1) : MapSchemeTileType.LAND,
			BoardPosition.new(0, 0) : MapSchemeTileType.LAND,
			BoardPosition.new(0, 1) : MapSchemeTileType.LAND,
			BoardPosition.new(0, 2) : MapSchemeTileType.LAND,
			BoardPosition.new(1, -2) : MapSchemeTileType.LAND,
			BoardPosition.new(1, -1) : MapSchemeTileType.LAND,
